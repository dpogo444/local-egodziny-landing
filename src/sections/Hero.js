                ...
                <Col xs={12} md={6} className='text-md-start'>
                    ...
                    <Row className='py-3'>
                        <Col className='d-flex flex-row flex-md-column justify-content-evenly'>
                            <Button className='button-default d-block mb-3' onClick={() => {tryFree(); handleButtonClick('try_free_hero');}}>
                                {hero.button1}
                            </Button>

                            <Button variant="outline-dark" className='outline mb-3 mb-md-0 me-md-3' href="/#functionality" onClick={() => handleButtonClick('check_system_hero')}>
                                {hero.button2}
                            </Button>
                        </Col>
                    </Row>
